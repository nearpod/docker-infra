...
|:------:|:---:|:-----:|:---------|
|ZK_REPLICAS|string|N/A|The number of replicas used by this cluster.|

This is a mandatory configuration variable that is used to configure the membership of the
ZooKeeper ensemble. It reads the servername and id from the hostname (ie. the hostname should be zk-0, zk-1, etc.).
...
License Declaration
-------------------
The k8szk project was licensed as APL 2.0. That declaration follows.
